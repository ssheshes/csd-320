/*Alexis Yang
CSD 320 Assignment 1
17 October 2023 */

public class yangAssignment1 {
    public static void main(String[] args) {
        //Displays the results of the following equations
        System.out.print("4*(1.0-1.0/3.0+1.0/5.0-1.0/7.0+1.0/9.0-1.0/11.0+1.0/13.0) = ");
